...
public class NetClientHandler extends NetHandler
{
	...
	else if ( TSGArrowManager.MatchArrow(par1Packet23VehicleSpawn.type)){
		var8 = TSGArrowManager.CreateArrow(par1Packet23VehicleSpawn.type, worldClient, var2, var4, var6);
	}
        // END FCMOD
