...
public class TSGTheifarrows extends FCAddOn{
	...
	public void
	addEntityRenderers(){
		RenderManager.AddEntityRenderer(TSGEntityArrowEnder.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowEnder.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowIgnite.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowIgnite.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowRope.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowRope.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowTorch.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowTorch.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowDousing.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowDousing.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowTorchNether.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowTorch.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowOrange.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowOrange.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowWarcrime.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowWarcrime.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowTorchRedstone.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowTorchRedstone.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowPotion.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowPotion.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowSnow.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowSnow.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowRising.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowRising.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowAccelerator.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowAccelerator.png"));
		RenderManager.AddEntityRenderer(TSGEntityArrowSplitting.class, new TSGRenderGenericArrow("/textures/TSGTheifArrowEntityAssets/taEntityArrowSplitting.png"));
