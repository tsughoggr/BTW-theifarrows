	...
	implements IProjectile, FCIEntityPacketHandler
{
    ...
    {
    	FCUtilsItem.EjectSingleItemWithRandomVelocity( worldObj, (float)posX, (float)posY, (float)posZ, (m_iItemShiftedIndex == 0)?FCBetterThanWolves.fcItemDynamite.itemID:m_iItemShiftedIndex, 0 );
