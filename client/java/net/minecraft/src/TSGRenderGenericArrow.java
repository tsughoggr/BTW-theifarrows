...
public class TSGRenderGenericArrow extends Render {
	private String fn;
	public
	TSGRenderGenericArrow(String file){
		super();
		fn = file;
	}

	public void
	doRender(Entity var1, double var2, double var4, double var6, float var8, float var9){
		if(var1.prevRotationYaw != 0.0F || var1.prevRotationPitch != 0.0F) {
			...
			float var21 = ((float)(((EntityArrow)(var1)).arrowShake)) - var9;
			if(var21 > 0.0F) {
