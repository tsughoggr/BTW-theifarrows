...
public class TSGBlockAnchor extends Block{ 
	...
	registerIcons(IconRegister var1){
		tex = var1.registerIcon("wood");
		ropetex = var1.registerIcon("fcBlockRope_side");
	}
	public Icon
	...
	RenderBlock(RenderBlocks rb, int x, int y, int z){
		FCModelBlock model[] = new FCModelBlock[2];
		model[0] = new FCModelBlock();
		model[1] = new FCModelBlock();
		model[0].AddBox(0D, 7D/16D, 7D/16D, 7D/16D,9D/16D, 9D/16D );
		model[0].AddBox(7D/16D, 7D/16D, 0D, 9D/16D, 9D/16D, 7D/16D);
		model[0].AddBox(9D/16D, 7D/16D,7D/16D,1D,9D/16D,9D/16D );
		model[0].AddBox(7D/16D,7D/16D,9D/16D,9D/16D, 9D/16D,1D);
		model[1].AddBox(7D/16D,0D,7D/16D,9D/16D,9D/16D,9D/16D);
		model[0].RenderAsBlockWithTexture(rb,this, x,y,z,tex);
		return model[1].RenderAsBlockWithTexture(rb,this, x,y,z,ropetex);
	}
	public void
	RenderBlockAsItem(RenderBlocks rb, int md, float cd){
		...
		model[0].AddBox(7D/16D,7D/16D,9D/16D,9D/16D, 9D/16D,1D);
		model[1].AddBox(7D/16D,0D,7D/16D,9D/16D,9D/16D,9D/16D);
		model[0].RenderAsItemBlock(rb,this, md);
		model[1].RenderAsItemBlock(rb,this, md);
	}
